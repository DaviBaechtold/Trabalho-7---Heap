...
/*
Sua tarefa será construir um heap (binário, max-heap), e criar métodos para criar a árvore e a partir de um array, inserir, excluir, e buscar valores na árvore. Seu objetivo é explicar o funcionamento dos  métodos  que  você  irá  criar.  Para  isso,  deve  buscar  em  sites  acadêmicos,  exemplos  de 
...
int main(){
  ...
  printf("\nExcluindo o número 57...\n\n");
  excluir(array,57);
  
  printf("Array: ");
  printArray(array,tam);

  printf("\nBuscando o número 42...\n\n");
  if (buscar(array,42) == true){
